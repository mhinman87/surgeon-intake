...
import PostopTHAComplaintForm from './PostopTHAComplaintForm';
import MedicalHistoryPrompt from './MedicalHistoryPrompt';
import MedicalHistoryForm from './MedicalHistoryForm';
import PostopTHAReviewForm from './PostopTHAReviewForm';
import { generatePostopTHAReportPDF } from '../utils/postopThaPdfGenerator';
...
export default function PostopTHAIntakeForm() {
  ...
  const onSubmit = (data) => {
    ...
    try {
      ...
      generatePostopTHAReportPDF(data);
  ...
  const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return <PostopTHAComplaintForm />;
      case 1:
        return <MedicalHistoryPrompt />;
      case 2:
        return <PostopTHAReviewForm />;
      default:
        return 'Unknown step';
    }
  };
      ...
      <Box sx={{ width: '100%' }}>
            ...
            {activeStep === steps.length - 1 ? (
              <Button variant="contained" onClick={async () => {
                ...
                try {
                  ...
                  // Also generate PDF
                  generatePostopTHAReportPDF(formData);
                  console.log('PDF generation completed');
        ...
        >
          <Alert onClose={() => setShowSuccess(false)} severity="success">
            Post-op THA intake form submitted successfully! PDF report generated.
          </Alert>
        </Snackbar>
      </Box>
    </FormProvider>
