...
import FollowupPainfulTKAComplaintForm from './FollowupPainfulTKAComplaintForm';
import MedicalHistoryPrompt from './MedicalHistoryPrompt';
import MedicalHistoryForm from './MedicalHistoryForm';
import FollowupPainfulTKAReviewForm from './FollowupPainfulTKAReviewForm';
import { generateFollowupPainfulTKAReportPDF } from '../utils/followupPainfulTkaPdfGenerator';
...
export default function FollowupPainfulTKAIntakeForm() {
  ...
  const getFieldsForStep = (step) => {
    switch (step) {
      case 0:
        return [
          'kneeSide', 'knownHistory', 'treatmentPlan', 'otherTreatment',
  ...
  const onSubmit = (data) => {
    ...
    try {
      ...
      generateFollowupPainfulTKAReportPDF(data);
  ...
  const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return <FollowupPainfulTKAComplaintForm />;
      case 1:
        return <MedicalHistoryPrompt />;
      case 2:
        return <FollowupPainfulTKAReviewForm />;
      default:
        return 'Unknown step';
    }
  };
      ...
      <Box sx={{ width: '100%' }}>
            ...
            {activeStep === steps.length - 1 ? (
              <Button variant="contained" onClick={async () => {
                ...
                try {
                  ...
                  // Also generate PDF
                  generateFollowupPainfulTKAReportPDF(formData);
                  console.log('PDF generation completed');
        ...
        >
          <Alert onClose={() => setShowSuccess(false)} severity="success">
            Follow-up painful TKA intake form submitted successfully! PDF report generated.
          </Alert>
        </Snackbar>
      </Box>
    </FormProvider>
